    ...
    class Suspect extends React.Component {
        ...
        updateSuspectDetails = (suspect_id) => {
            ...
            let complaint_id_suspect = id,
                ...
                complaint_action_suspect = document.getElementById("sus_complaint_action_" + suspect_id).value?document.getElementById("sus_complaint_action_" + suspect_id).value : suspect.complaint_action,
                ...
                <h1 class=" h1 h2-complaint">संदेहियों की जानकारी</h1>
                {
                            this.state.suspects ? this.state.suspects.map((suspect,i) => (    
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td style={{fontSize:"1.11rem"}}><h4 class="ui header theme-color mb-1 mt-1">शिकायत की कार्रवाई</h4><input class="rounded py-2 mt-1 px-2" id={"sus_complaint_action_" + suspect.suspect_id } type="text" placeholder={suspect.complaint_action} /></td>
    ...
    class BankAccounts extends React.Component {
        ...
        updateAccountDetails = (account_id) => {
            ...
            let complaint_id_acc = id,
                ...
                suspect_accounts_date = new Date(),
                last_updated_acc = currentDate(suspect_accounts_date);
    ...
    class Ewallets extends React.Component {
        ...
        updateEwalletsDetails = (suspect_ewallet_id) => {
            ...
            let complaint_id_e = id,
                ...
                device_id_e = document.getElementById("ewallet_device_id_" + suspect_ewallet_id).value?document.getElementById("ewallet_device_id_" + suspect_ewallet_id).value : ewallet.device_id,
                merchandise_e = document.getElementById("ewallet_merchandise_" + suspect_ewallet_id).value?document.getElementById("ewallet_merchandise_" + suspect_ewallet_id).value : ewallet.merchandise,
                hold_amount_e = document.getElementById("ewallet_hold_amount_" + suspect_ewallet_id).value?document.getElementById("ewallet_hold_amount_" + suspect_ewallet_id).value : ewallet.hold_amount,
                number_e = document.getElementById("ewallet_number_" + suspect_ewallet_id).value?document.getElementById("ewallet_number_" + suspect_ewallet_id).value : ewallet.number,
