                                        ...
                                        <div class="card card-body">
                                            <div class="num-detail-form-div">
                                                <form id="num_detailform" class="num-detail-form ui blue segment form"
                                                    ...
                                                    <!--------CDR details------->
                                                    <!-------------------------->
                                                    <button type="button" class="add-number-cdr-btn ui button my-3"
                                                    ...
                                                    <!---------IPDR details-------->
                                                    <!----------------------------->
                                                    <button type="button" class="add-number-ipdr-btn ui button my-3"
                                                ...
                                                <form id="acc_detailform" class="acc-detail-form" method="POST"
                                                    ...
                                                    <div class="card card-body">
                                                        <div class="contact-list py-4">
                                                            ...
                                                            <button type="button" class="add-number-btn ui button my-3"
