...
>>>>>>> 0bef3b0e05d7278da8d2d1dd12e11f833297046c
                                                    ...
                                                    <div class="three fields">
                                                        <div class="four wide field">
                                                            ...
                                                            <input type="date" name="email_sent"
                                                                placeholder="ईमेल जावक">
                                                        </div>
                                                        <div class="four wide field">
                                                            <label>ईमेल आवक</label>
                                                            <input type="date" name="email_received"
                                                ...
                                                <form id="acc_detailform" class="acc-detail-form" method="POST"
                                                    ...
                                                    <div class="four fields">
                                                        ...
                                                        <div class="six wide field">
                                                            ...
                                                            <input type="tel" name="branch_name"
                                                                placeholder="ब्रांच नाम" />
                                                        </div>
                                                        <div class="six wide field">
                                                            <label>मेल दिनाक</label>
                                                            <input type="date" name="mail_date"
                                                                placeholder="ब्रांच नाम" />
                                                        </div>
                                                        <div class="six wide field">
                                                            <label>मेल प्राप्त </label>
                                                    ...
                                                    <div class="four fields">
                                                        ...
                                                        <div class="six wide field">
                                                            ...
                                                            <input type="text" name="profit_acc"
                                                ...
                                                <form id="wallet_detailform" class="wallet-detail-form" method="POST"
                                                    ...
                                                    <div class="three fields">
                                                        ...
                                                        <div class="eight wide field">
                                                            ...
                                                            <input type="text" name="pen_reason"
                                                    ...
                                                    <div class="four fields">
                                                        ...
                                                        <div class="four wide field">
                                                            ...
                                                            <input type="text" name="benificiar"
